...
const hasTransformChanged = (nextScale, nextRotation, nextX, nextY, defaultScale, defaultRotation) => {
    "worklet";
    return (nextScale !== defaultScale ||
...
const DraggablePanPinch = ({ children, style, initialScale = 1, initialRotation = 0, maxScale = 5, minScale = 0.5, boundaryX, boundaryY, enablePan = true, enablePinch = true, enableRotation = false, onScaleChange, onPositionChange, onRotationChange, showButtons = {
    ...
    rotateRight: false,
    reset: false,
}, actionButtons, actionButtonsContainerStyle, actionButtonsStyle, actionButtonIconStyle, rotateDegree = 90, zoomScale = 0.5, }) => {
    var _a, _b, _c, _d, _e;
    ...
    const [hasTransformChanges, setHasTransformChanges] = react_1.default.useState(false);
    ...
    const transformChanged = (0, react_native_reanimated_1.useSharedValue)(false);
    const zoomFactor = 1 + zoomScale;
    const syncHasTransformChanges = react_1.default.useCallback((nextHasChanges) => {
    ...
    const animateScaleBy = react_1.default.useCallback((multiplier) => {
        (0, react_native_reanimated_1.runOnUI)((factor) => {
            ...
            const nextHasChanges = hasTransformChanged(nextScale, rotation.value, positionX.value, positionY.value, clampedInitialScale, initialRotation);
            if (transformChanged.value !== nextHasChanges) {
                transformChanged.value = nextHasChanges;
                (0, react_native_reanimated_1.runOnJS)(syncHasTransformChanges)(nextHasChanges);
            }
            if (onScaleChange) {
    ...
    const animateRotationBy = react_1.default.useCallback((delta) => {
        (0, react_native_reanimated_1.runOnUI)((rotationDelta) => {
            ...
            const nextHasChanges = hasTransformChanged(scale.value, nextRotation, positionX.value, positionY.value, clampedInitialScale, initialRotation);
            if (transformChanged.value !== nextHasChanges) {
                transformChanged.value = nextHasChanges;
                (0, react_native_reanimated_1.runOnJS)(syncHasTransformChanges)(nextHasChanges);
            }
    ...
    const resetTransform = react_1.default.useCallback(() => {
        (0, react_native_reanimated_1.runOnUI)((defaultScale, defaultRotation) => {
            "worklet";
            (0, react_native_reanimated_1.cancelAnimation)(scale);
            (0, react_native_reanimated_1.cancelAnimation)(rotation);
            (0, react_native_reanimated_1.cancelAnimation)(positionX);
            (0, react_native_reanimated_1.cancelAnimation)(positionY);
            scale.value = (0, react_native_reanimated_1.withTiming)(defaultScale);
            savedScale.value = defaultScale;
            rotation.value = (0, react_native_reanimated_1.withTiming)(defaultRotation);
            savedRotation.value = defaultRotation;
            positionX.value = (0, react_native_reanimated_1.withTiming)(0, { duration: 100 });
            positionY.value = (0, react_native_reanimated_1.withTiming)(0, { duration: 100 });
            startTranslateX.value = 0;
            startTranslateY.value = 0;
            if (transformChanged.value) {
                transformChanged.value = false;
                (0, react_native_reanimated_1.runOnJS)(syncHasTransformChanges)(false);
            }
            if (onScaleChange) {
                (0, react_native_reanimated_1.runOnJS)(emitScaleChange)(defaultScale);
            }
            if (onPositionChange) {
                (0, react_native_reanimated_1.runOnJS)(emitPositionChange)(0, 0);
            }
            if (onRotationChange) {
                (0, react_native_reanimated_1.runOnJS)(emitRotationChange)(defaultRotation);
            }
    ...
    const panGesture = react_native_gesture_handler_1.Gesture.Pan()
        ...
        const nextHasChanges = hasTransformChanged(scale.value, rotation.value, nextX, nextY, clampedInitialScale, initialRotation);
        if (transformChanged.value !== nextHasChanges) {
            transformChanged.value = nextHasChanges;
            (0, react_native_reanimated_1.runOnJS)(syncHasTransformChanges)(nextHasChanges);
        }
        ...
        const nextHasChanges = hasTransformChanged(scale.value, rotation.value, clampedX, clampedY, clampedInitialScale, initialRotation);
        if (transformChanged.value !== nextHasChanges) {
            transformChanged.value = nextHasChanges;
            (0, react_native_reanimated_1.runOnJS)(syncHasTransformChanges)(nextHasChanges);
        }
    ...
    const showActionButtons = showResetButton ||
        Boolean(enableRotation && (showButtons.rotateLeft || showButtons.rotateRight)) ||
    ...
    return (<react_native_1.View style={styles.wrapper}>
      {showActionButtons && (<react_native_1.View style={[styles.buttonsContainer, actionButtonsContainerStyle]}>
          {enableRotation && showButtons.rotateLeft && (<react_native_1.TouchableOpacity style={[styles.button, actionButtonsStyle]} onPress={onPressRotateLeft}>
              {(_a = actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.rotateLeft) !== null && _a !== void 0 ? _a : <react_native_1.Text style={[styles.buttonText, actionButtonIconStyle]}>↺</react_native_1.Text>}
          ...
          {enableRotation && showButtons.rotateRight && (<react_native_1.TouchableOpacity style={[styles.button, actionButtonsStyle]} onPress={onPressRotateRight}>
              {(_b = actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.rotateRight) !== null && _b !== void 0 ? _b : <react_native_1.Text style={[styles.buttonText, actionButtonIconStyle]}>↻</react_native_1.Text>}
            </react_native_1.TouchableOpacity>)}
          {enablePinch && showButtons.zoomIn && (<react_native_1.TouchableOpacity style={[styles.button, actionButtonsStyle]} onPress={onPressZoomIn}>
              {(_c = actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.zoomIn) !== null && _c !== void 0 ? _c : <react_native_1.Text style={[styles.buttonText, actionButtonIconStyle]}>+</react_native_1.Text>}
            </react_native_1.TouchableOpacity>)}
          {enablePinch && showButtons.zoomOut && (<react_native_1.TouchableOpacity style={[styles.button, actionButtonsStyle]} onPress={onPressZoomOut}>
              {(_d = actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.zoomOut) !== null && _d !== void 0 ? _d : <react_native_1.Text style={[styles.buttonText, actionButtonIconStyle]}>-</react_native_1.Text>}
            </react_native_1.TouchableOpacity>)}
          {showResetButton && (<react_native_1.TouchableOpacity accessibilityLabel="Reset image" accessibilityRole="button" style={[styles.button, actionButtonsStyle]} onPress={onPressReset}>
              {(_e = actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.reset) !== null && _e !== void 0 ? _e : <react_native_1.Text style={[styles.buttonText, actionButtonIconStyle]}>⟲</react_native_1.Text>}
            </react_native_1.TouchableOpacity>)}
        </react_native_1.View>)}
